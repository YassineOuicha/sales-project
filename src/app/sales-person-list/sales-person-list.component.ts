...
export class SalesPersonListComponent implements OnInit {
  ...
  salesPersonList: SalesPerson[] = [
    ...
    new SalesPerson("Emma", "Dupont", "emma.dupont@email.com", 14547),
    new SalesPerson("Hugo", "Morel", "hugo.morel@email.com", 3453),
    new SalesPerson("Léa", "Rousseau", "lea.rousseau@email.com", 24755),
    new SalesPerson("Arthur", "Lefebvre", "arthur.lefebvre@email.com", 58486),
    ...
    new SalesPerson("Jules", "Simon", "jules.simon@email.com", 54454),
